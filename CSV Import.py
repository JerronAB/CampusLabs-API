...
Section_Export.CSVimport('class_table_4244.csv')
...
Section_Export.CSVexport('../4244_sections_report_temp.csv')
...
Course_Export.CSVimport('class_table_4244.csv')
...
Course_Export.CSVexport('../4244_course_report_temp.csv')
...
Instructors_Export.CSVimport('class_table_4244.csv')
...
Instructors_Export.CSVexport('../4244_instrs_report_temp.csv')
